...
def update_galileo_pointing_attributes(l1file):
    ...
    DS['azimuth'].comment += "\n" + "Azimuths are specified to the nearest cardinal, primary or secondary intercardinal compass bearing (i.e. N, NE, NNE etc.). Values are derived from analysis by John Nicol (john@weatherradar.co.nz) of Doppler returns from thin ice at the tops of clouds that have negligible velocity, and measuring the apparent velocity induced by strong winds that change direction over a period of several hours. The speed and direction of the winds at the appropriate height are taken from ECMWF (European Centre for Medium-Range Weather Forecasts) model data."
...
def encode_antenna_mispointing(l1file,elevation_offset,azimuth):
    ...
    DS['azimuth'][:] = azimuth;
    DS['azimuth'].comment = "Azimuths are specified to the nearest cardinal, primary or secondary intercardinal compass bearing (i.e. N, NE, NNE etc.). Values are derived from analysis by John Nicol (john@weatherradar.co.nz) of Doppler returns from thin ice at the tops of clouds that have negligible velocity, and measuring the apparent velocity induced by strong winds that change direction over a period of several hours. The speed and direction of the winds at the appropriate height are taken from ECMWF (European Centre for Medium-Range Weather Forecasts) model data."
