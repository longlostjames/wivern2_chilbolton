...
#raw_ts_path_3ghz = os.path.join(raw_ts_root_3ghz,datestr,'EventA');
...
raw_ts_root_35ghz = '/gws/nopw/j04/ncas_obs/cao/raw_data/ncas-radar-ka-band-1/data/campaign/wivern2/ts/'
raw_ts_path_35ghz = os.path.join(raw_ts_root_35ghz,datestr);
...
figfile = "esa-wivern2-radar-35ghz_{}.png".format(datestr);
